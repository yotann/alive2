...
define void @music_task(i8* nocapture readnone %p, %struct._MUSIC_OP_API_* %mapi_init) {
entry:
  ...
  store %struct._MUSIC_OP_API_* %mapi_init, %struct._MUSIC_OP_API_** %mapi, align 8
...
sw.bb13:                                          ; preds = %while.cond2
  ...
  %11 = load %struct.__MUSIC_API*, %struct.__MUSIC_API** %dop_api14, align 8  %file_num15 = getelementptr inbounds %struct.__MUSIC_API, %struct.__MUSIC_API* %11, i64 0, i32 2
